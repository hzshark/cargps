...
//mp.centerAndZoom(new BMap.Point(116.380797, 39.918497), 18);


//设置标注的图标
var icon = new BMap.Icon('C:/data/1.jpg', 
		new BMap.Size(200, 300), {//是引用图标的名字以及大小，注意大小要一样
    		anchor: new BMap.Size(10, 30)//这句表示图片相对于所加的点的位置
		}
);
//设置标注的经纬度
var mkr = new BMap.Marker(new BMap.Point(121.481414,31.236151), {
    icon: icon
});
//把标注添加到地图上
mp.addOverlay(mkr);  
var content = "<div class=\"car-icon\">";  
content = content + "<a class=\"glyph-search search-btn\" href=\"#\" style=\"font-size:30px; color:#f30\"><span>u</span></a>";
content = content + "<div class=\"pop-s\"> <span>浙AQ83a25</span> <i>1123KM/H</i>";
content = content + "<div class=\"triangle-down\"></div>";
...
//var point = new BMap.Point(121.48061, 31.235587);    
//mp.centerAndZoom(point, 15);    
// 添加自定义覆盖物   
var marker = new BMap.Marker(new BMap.Point(121.48061, 31.235587));  
...
var myCompOverlay = new ComplexCustomOverlay(new BMap.Point(121.481077, 31.237007), txt, speed);


mp.addOverlay(myCompOverlay);

////点击地图，获取经纬度坐标121.48061, 31.235587
//mp.addEventListener("click",function(e){
//	var content1 = "<div class=\"car-icon\">";  
//	content1 = content1 + "<a class=\"glyph-search search-btn\" href=\"#\" style=\"font-size:30px; color:#f30\"><span>u</span></a>";
//	content1 = content1 + "<div class=\"pop-s\"> <span>经度坐标："+e.point.lng+"</span> <i>纬度坐标："+e.point.lat+"</i>";
//	content1 = content1 + "<div class=\"triangle-down\"></div>";
