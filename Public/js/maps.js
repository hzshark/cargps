...
var icon = new BMap.Icon('C:/data/1.jpg',
		new BMap.Size(20, 30), {//是引用图标的名字以及大小，注意大小要一样
    		anchor: new BMap.Size(10, 30)//这句表示图片相对于所加的点的位置
		}
);
//设置标注的经纬度
var mkr = new BMap.Marker(new BMap.Point(120.21799400,30.21028600), {
    icon: icon
});
//把标注添加到地图上
mp.addOverlay(mkr);
...
function addmarker2map(longitude, latitude, text, speed){
	var myCompOverlay = new ComplexCustomOverlay(new BMap.Point(longitude,latitude), txt, speed);
